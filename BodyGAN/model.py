...
class Generator(Chain):
    ...
    def __call__(self, z1, z2):
        ...
        h_1 = F.reshape(self.l0_seg(z1), (b, 64*8, 4, 3))
        ...
        h = F.reshape(self.l0_body(z2), (b, 64 * 8, 4, 3))
...
class Discriminator(Chain):
    def __init__(self, base=64, activation=F.leaky_relu):
        ...
        with self.init_scope():
            ...
            self.l1_body = SNLinear(None, 1, initialW=w)
            ...
            self.l1_seg = SNLinear(None, 1, initialW=w)
